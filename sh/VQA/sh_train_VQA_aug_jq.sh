...
#SBATCH -J VQA_aug_jq        # 作业在调度系统中的作业名为myFirstJob;
...
path_dir='/home/zhengf_lab/cse30008213/ld'

source activate base 

python -m torch.distributed.run --nproc_per_node=4 --master_port 1899 VQA_aug.py \
--config ${path_dir}/multimodal_models/ALBEF_sammy/configs/VQA_jq.yaml \
--output_dir ${path_dir}/multimodal_models/ALBEF_sammy/fine_tune_aug/VQA \
