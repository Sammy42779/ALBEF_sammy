...
#SBATCH -J VE_aug_jq        # 作业在调度系统中的作业名为myFirstJob;
...
python -m torch.distributed.run --nproc_per_node=4 --master_port 1899 VE_aug.py \
--config ${path_dir}/multimodal_models/ALBEF_sammy/configs/VE_jq.yaml \
--output_dir ${path_dir}/multimodal_models/ALBEF_sammy/fine_tune_aug/VE \
