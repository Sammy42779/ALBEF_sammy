...
out='/ssd2/ld/ICCV2023/multimodal_models/ALBEF_sammy/fine_tune/VE/IC'
...
do
CUDA_VISIBLE_DEVICES=6,5,3 python -m torch.distributed.launch --nproc_per_node=3 --use_env --master_port 1999 VE_eval_IC.py \
